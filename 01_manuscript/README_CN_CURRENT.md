...
### 1. 当前主稿
- [MANUSCRIPT_DRAFT_V8_CN.md](/C:/Users/SWH/Desktop/GitHub_Docs_Package/Code_Archive/paper_flexible_sensor_lung_nodule_localization/tbme_submission_release_v1/01_manuscript/MANUSCRIPT_DRAFT_V8_CN.md)
...
### 2. 当前图表组织方案
- [FIGURE_AND_TABLE_DRAFT_V2_CN.md](/C:/Users/SWH/Desktop/GitHub_Docs_Package/Code_Archive/paper_flexible_sensor_lung_nodule_localization/tbme_submission_release_v1/01_manuscript/FIGURE_AND_TABLE_DRAFT_V2_CN.md)
...
这些文件保留是为了追踪思路演化，不再作为当前主文入口。


## 最推荐的阅读顺序
1. `MODEL_ROLE_MAP_CN.md`
2. `MANUSCRIPT_DRAFT_V8_CN.md`
3. `FIGURE_AND_TABLE_DRAFT_V2_CN.md`
4. `03_results_core/latency_benchmark_v1/`
